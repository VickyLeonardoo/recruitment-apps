<nav x-data="{ open: false }" class="bg-sky-200 border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-2">
                        <img src="https://www.svgrepo.com/show/324381/search-career-work-job-recruitment-employee-2.svg"
                            alt="Recruitment Logo" class="h-8 w-8">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('applicant.application.index')" :active="request()->routeIs('applicant.application*')">
                        {{ __('Lamaran Saya') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        @else
            <div class="pt-4 pb-1 border-t border-gray-200">
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('login')" class="text-gray-600 hover:text-blue-400 hover:bg-blue-50">
                        {{ __('Masuk') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('register')" class="text-gray-600 hover:text-blue-400 hover:bg-blue-50">
                        {{ __('Daftar') }}
                    </x-responsive-nav-link>
                </div>
            </div>
