            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <form method="POST" action="{{ route('job.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="responsibilities" name="responsibilities" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="4" required>{{ old('responsibilities') }}</textarea>
